# LOCK-ROW-NORMAL-SELECT-NONBLOCKING
...
- factor_values: F01-V09,F02-V05,F03-V02,F04-V02
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.3-explicit-locking/13.3.2-row-level-locks/lock-row-normal-select-nonblocking.md