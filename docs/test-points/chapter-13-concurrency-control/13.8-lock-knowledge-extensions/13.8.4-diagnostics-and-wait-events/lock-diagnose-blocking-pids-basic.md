# LOCK-DIAGNOSE-BLOCKING-PIDS-BASIC
...
## 来源依据摘要
构造阻塞后，通过 pg_blocking_pids(pid) 定位 blocker 和 blocked。
...
## 标记理由
P0 测试点；用于覆盖本地知识补充 13.8.4 Diagnostics And Wait Events 中的 构造阻塞后，通过 pg_blocking_pids(pid) 定位 blocker 和 blocked。

## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.8-lock-knowledge-extensions/13.8.4-diagnostics-and-wait-events/lock-diagnose-blocking-pids-basic.md