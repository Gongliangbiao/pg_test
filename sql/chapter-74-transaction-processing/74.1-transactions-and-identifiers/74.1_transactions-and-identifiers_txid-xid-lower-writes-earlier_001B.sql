...
\! sh commonScript/get_sync_point.sh txid_xid_lower_writes_earlier_s1_to_s2_01
BEGIN;
...
COMMIT;
\! sh commonScript/set_sync_point.sh txid_xid_lower_writes_earlier_s2_to_s1_01
\! sh commonScript/get_sync_point.sh txid_xid_lower_writes_earlier_s1_to_s2_02
SELECT id, writer, xid_text IS NOT NULL AS has_xid FROM tab_741_txid_xid_lower_writes_earlier ORDER BY id;
