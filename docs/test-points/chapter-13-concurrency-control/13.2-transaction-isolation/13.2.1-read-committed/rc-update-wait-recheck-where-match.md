...
## 官方依据摘要
UPDATE 等待并发事务结束后重检 WHERE，匹配则继续更新。
...
- factor_values: F01-V18,F02-V16,F03-V02,F04-V01
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.2-transaction-isolation/13.2.1-read-committed/rc-update-wait-recheck-where-match.md