...
## 官方依据摘要
某些 exclusion_violation SQLSTATE 23P01 可按场景谨慎重试。
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.5-serialization-failure-handling/retry-23p01-exclusion-race.md