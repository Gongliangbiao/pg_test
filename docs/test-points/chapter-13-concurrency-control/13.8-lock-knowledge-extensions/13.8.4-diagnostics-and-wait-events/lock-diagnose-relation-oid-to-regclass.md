# LOCK-DIAGNOSE-RELATION-OID-TO-REGCLASS
...
## 来源依据摘要
使用 pg_locks.relation::regclass 将 relation oid 转成表名，辅助定位被锁对象。
...
## 标记理由
P0 测试点；用于覆盖本地知识补充 13.8.4 Diagnostics And Wait Events 中的 使用 pg_locks.relation::regclass 将 relation oid 转成表名，辅助定位被锁对象。

## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.8-lock-knowledge-extensions/13.8.4-diagnostics-and-wait-events/lock-diagnose-relation-oid-to-regclass.md