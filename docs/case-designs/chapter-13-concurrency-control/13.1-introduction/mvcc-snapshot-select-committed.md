...
## 来源
- source_test_point: docs/test-points/chapter-13-concurrency-control/13.1-introduction/mvcc-snapshot-select-committed.md
...
## 表结构设计
- 表名使用 tab_131_mvcc_snapshot_select_committed，列类型按 MVCC 场景选择文本、数值或时间戳字段。
