# LOCK-ADVISORY-LIMIT-ORDER-BY-RISK
...
## 官方依据摘要
Advisory lock 函数与 ORDER BY / LIMIT 组合存在求值顺序风险。
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.3-explicit-locking/13.3.5-advisory-locks/lock-advisory-limit-order-by-risk.md