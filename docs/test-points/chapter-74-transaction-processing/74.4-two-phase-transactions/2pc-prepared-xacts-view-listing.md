# 2PC-PREPARED-XACTS-VIEW-LISTING
...
## 重要边界
- 被测对象/语句：SELECT / PREPARE TRANSACTION / diagnostic view。
- 触发状态/条件：常规事务状态转换。
- 边界或异常：诊断观测。
