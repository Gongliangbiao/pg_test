# MVCC-IDLE-IN-TRANSACTION-VACUUM-RISK
...
## 来源依据摘要
idle in transaction 不只是持锁风险，还会阻碍 vacuum、造成膨胀和事务 ID 年龄风险。
...
## 标记理由
P0 测试点；用于覆盖本地知识补充 13.8.5 Mvcc Vacuum And Long Transactions 中的 idle in transaction 不只是持锁风险，还会阻碍 vacuum、造成膨胀和事务 ID 年龄风险。

## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.8-lock-knowledge-extensions/13.8.5-mvcc-vacuum-and-long-transactions/mvcc-idle-in-transaction-vacuum-risk.md