# TCL-SET-SNAPSHOT-REQUIRES-RR-OR-SERIALIZABLE
...
## 官方依据摘要
SET TRANSACTION SNAPSHOT 只能在事务开始处，且事务隔离级别已为 REPEATABLE READ 或 SERIALIZABLE。

## 来源因子
- factor_matrix: docs/test-factors/chapter-74-transaction-processing/appendix-a-tcl-command-boundaries/factor-matrix.md
- factor_values: F01-V17,F02-V06,F03-V01,F04-V02
