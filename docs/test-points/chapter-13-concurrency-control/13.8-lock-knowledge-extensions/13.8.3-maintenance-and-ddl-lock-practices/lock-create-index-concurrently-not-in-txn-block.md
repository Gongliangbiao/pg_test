# LOCK-CREATE-INDEX-CONCURRENTLY-NOT-IN-TXN-BLOCK
...
## 来源依据摘要
CREATE INDEX CONCURRENTLY 不能在普通事务块中执行。
...
## 标记理由
P0 测试点；用于覆盖本地知识补充 13.8.3 Maintenance And Ddl Lock Practices 中的 CREATE INDEX CONCURRENTLY 不能在普通事务块中执行。

## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.8-lock-knowledge-extensions/13.8.3-maintenance-and-ddl-lock-practices/lock-create-index-concurrently-not-in-txn-block.md