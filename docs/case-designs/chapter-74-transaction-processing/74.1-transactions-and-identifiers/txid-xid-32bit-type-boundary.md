# TXID-XID-32BIT-TYPE-BOUNDARY

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-xid-32bit-type-boundary.md
...
## 测试目标
内部 xid 是 32 位类型，测试设计需覆盖接近 32 位上界的显示、比较或转换边界。
...
## 表结构设计
- 表名使用 tab_741_txid_xid_32bit_type_boundary，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
