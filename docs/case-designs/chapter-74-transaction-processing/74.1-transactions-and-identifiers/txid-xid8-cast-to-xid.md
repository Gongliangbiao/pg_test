# TXID-XID8-CAST-TO-XID

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-xid8-cast-to-xid.md
...
## 测试目标
xid8 可转换为 xid，测试转换后低 32 位语义和边界表现。
...
## 表结构设计
- 表名使用 tab_741_txid_xid8_cast_to_xid，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
