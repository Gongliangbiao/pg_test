...
## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-implicit-single-stmt-rollback.md
...
## 表结构设计
- 表名使用 tab_741_txid_implicit_single_stmt_rollback，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
