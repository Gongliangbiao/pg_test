# TXID-GID-MAPPED-IN-PG-PREPARED-XACTS

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-gid-mapped-in-pg-prepared-xacts.md
...
## 测试目标
pg_prepared_xacts 可查看 GID 到 xid 的映射关系。
...
## 表结构设计
- 表名使用 tab_741_txid_gid_mapped_in_pg_prepared_xacts，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
