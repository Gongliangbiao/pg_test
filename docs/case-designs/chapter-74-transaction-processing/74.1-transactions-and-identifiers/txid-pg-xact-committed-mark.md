# TXID-PG-XACT-COMMITTED-MARK

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-pg-xact-committed-mark.md
...
## 测试目标
带非虚拟 xid 的顶层事务提交后，在 pg_xact 中记录 committed 状态。
...
## 表结构设计
- 表名使用 tab_741_txid_pg_xact_committed_mark，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
