# LOCK-ADVISORY-REENTRANT-ACQUIRE
...
## 官方依据摘要
同一会话可重复获取同一 advisory lock，需匹配释放。
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.3-explicit-locking/13.3.5-advisory-locks/lock-advisory-reentrant-acquire.md