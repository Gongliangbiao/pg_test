# 2PC-PREPARE-FAILURE-ROLLS-BACK-CURRENT-XACT
...
## 重要边界
- 被测对象/语句：PREPARE TRANSACTION / ROLLBACK。
- 触发状态/条件：常规事务状态转换。
- 边界或异常：错误/禁止场景。
