# LOCK-CREATE-INDEX-CONCURRENTLY-ALLOWS-WRITES
...
## 来源依据摘要
相对普通 CREATE INDEX，CREATE INDEX CONCURRENTLY 应允许更多并发写入，只持有更温和的锁。
...
## 标记理由
P0 测试点；用于覆盖本地知识补充 13.8.3 Maintenance And Ddl Lock Practices 中的 相对普通 CREATE INDEX，CREATE INDEX CONCURRENTLY 应允许更多并发写入，只持有更温和的锁。

## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.8-lock-knowledge-extensions/13.8.3-maintenance-and-ddl-lock-practices/lock-create-index-concurrently-allows-writes.md