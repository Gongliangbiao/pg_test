# TXID-GID-ASSIGNED-FOR-PREPARED

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-gid-assigned-for-prepared.md
...
## 测试目标
prepared transaction 除 vxid、xid 外，还具有 GID。
...
## 表结构设计
- 表名使用 tab_741_txid_gid_assigned_for_prepared，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
