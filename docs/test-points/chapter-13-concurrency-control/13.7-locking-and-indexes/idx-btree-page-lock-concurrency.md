# IDX-BTREE-PAGE-LOCK-CONCURRENCY
...
## 官方依据摘要
B-tree 使用短期 share/exclusive page-level locks，索引行 fetch 或 insert 后立即释放。
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.7-locking-and-indexes/idx-btree-page-lock-concurrency.md