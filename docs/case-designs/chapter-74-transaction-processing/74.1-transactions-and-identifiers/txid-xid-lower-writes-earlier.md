# TXID-XID-LOWER-WRITES-EARLIER

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-xid-lower-writes-earlier.md
...
## 表结构设计
- 表名使用 tab_741_txid_xid_lower_writes_earlier，用 writer 和 xid_text 观察不同 backend/首次写入顺序。
