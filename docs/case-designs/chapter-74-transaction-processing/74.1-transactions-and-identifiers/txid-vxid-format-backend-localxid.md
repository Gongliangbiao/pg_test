# TXID-VXID-FORMAT-BACKEND-LOCALXID

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-vxid-format-backend-localxid.md
...
## 测试目标
VirtualTransactionId 由 backendID/localXID 组成，格式可通过 pg_locks.virtualxid 观测。
...
## 表结构设计
- 表名使用 tab_741_txid_vxid_format_backend_localxid，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
