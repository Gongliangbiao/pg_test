# APP-BLOCKING-LOCK-TABLE-WHOLE-TABLE
...
## 官方依据摘要
LOCK TABLE locks the whole table for explicit consistency checks.
...
## 测试点
非 serializable 写存在时，LOCK TABLE 保护全表而不是单行。
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.4-data-consistency-checks-at-the-application-level/13.4.2-enforcing-consistency-with-explicit-blocking-locks/app-blocking-lock-table-whole-table.md