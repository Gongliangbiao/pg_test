...
\! sh commonScript/del_sync_points.sh mvcc_read_write_nonblocking_select_update
DROP TABLE IF EXISTS tab_131_mvcc_read_write_nonblocking_select_update;
CREATE TABLE tab_131_mvcc_read_write_nonblocking_select_update (id int PRIMARY KEY, reader_note text NOT NULL, score int NOT NULL DEFAULT 1);
INSERT INTO tab_131_mvcc_read_write_nonblocking_select_update VALUES (1, 'initial', 1);
BEGIN;
SELECT * FROM tab_131_mvcc_read_write_nonblocking_select_update ORDER BY id;
\! sh commonScript/set_sync_point.sh mvcc_read_write_nonblocking_select_update_s1_to_s2_01
\! sh commonScript/get_sync_point.sh mvcc_read_write_nonblocking_select_update_s2_to_s1_01
SELECT * FROM tab_131_mvcc_read_write_nonblocking_select_update ORDER BY id;
COMMIT;
