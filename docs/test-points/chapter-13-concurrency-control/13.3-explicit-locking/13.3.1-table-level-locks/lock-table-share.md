...
## 官方依据摘要
非 concurrently CREATE INDEX 获取 SHARE。
...
- factor_values: F01-V16,F02-V08,F03-V02,F04-V01
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.3-explicit-locking/13.3.1-table-level-locks/lock-table-share.md