# TXID-VXID-ASSIGNED-FOR-READONLY

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-vxid-assigned-for-readonly.md
...
## 测试目标
只读事务也具有唯一 VirtualTransactionId。
...
## 表结构设计
- 表名使用 tab_741_txid_vxid_assigned_for_readonly，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
