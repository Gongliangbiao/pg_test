...
## 官方依据摘要
Session-level advisory lock 跨事务保持，需显式释放。
...
- factor_values: F01-V06,F02-V01,F03-V01,F04-V01
...
## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.3-explicit-locking/13.3.5-advisory-locks/lock-advisory-session-level.md