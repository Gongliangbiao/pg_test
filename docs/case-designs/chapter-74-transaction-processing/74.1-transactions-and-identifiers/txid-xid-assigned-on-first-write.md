# TXID-XID-ASSIGNED-ON-FIRST-WRITE

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-xid-assigned-on-first-write.md
...
## 表结构设计
- 表名使用 tab_741_txid_xid_assigned_on_first_write，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
