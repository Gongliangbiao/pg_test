# TXID-EXPLICIT-BEGIN-ROLLBACK

## 来源
- source_test_point: docs/test-points/chapter-74-transaction-processing/74.1-transactions-and-identifiers/txid-explicit-begin-rollback.md
...
## 测试目标
BEGIN 或 START TRANSACTION 显式创建事务，ROLLBACK 放弃事务变更。
...
## 表结构设计
- 表名使用 tab_741_txid_explicit_begin_rollback，按事务 ID 观测场景使用 marker、numeric/date 或诊断函数输出。
