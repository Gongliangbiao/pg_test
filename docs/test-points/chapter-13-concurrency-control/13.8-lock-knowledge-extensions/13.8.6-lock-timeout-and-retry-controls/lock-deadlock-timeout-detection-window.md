# LOCK-DEADLOCK-TIMEOUT-DETECTION-WINDOW
...
## 来源依据摘要
deadlock_timeout 影响死锁检测启动时机，不等同于普通 lock wait timeout。
...
## 标记理由
P0 测试点；用于覆盖本地知识补充 13.8.6 Lock Timeout And Retry Controls 中的 deadlock_timeout 影响死锁检测启动时机，不等同于普通 lock wait timeout。

## 备注
来源：docs/archive/concurrency-control-by-official-chapter/13.8-lock-knowledge-extensions/13.8.6-lock-timeout-and-retry-controls/lock-deadlock-timeout-detection-window.md